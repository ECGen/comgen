...
xtable(as.data.frame(cn.geno.trait.pc.sr), digits = digits, xtable.comment = FALSE)

```

```{r table-cn-trait-pc-sr-geno, results = "asis", eval = eval_tables,echo=FALSE}

xtable(as.data.frame(cn.trait.pc.sr.geno), digits = digits, xtable.comment = FALSE)
...
xtable(as.data.frame(cn.l.cen.sr), digits = digits, xtable.comment = FALSE)

```

```{r table-cn-sr-l-cen, results = "asis", eval = eval_tables, echo = FALSE}

xtable(as.data.frame(cn.sr.l.cen), digits = digits, xtable.comment = FALSE)
