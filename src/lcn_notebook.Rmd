...
```{r echo = FALSE, eval = TRUE, results = "hide", warnings = FALSE, message = FALSE}
...
as.character(onc.nc[, 1]) 
as.character(onc.nc[, 1])[match(onc.dat[, "tree.id"], 
                                as.character(onc.nc[, 1]))]

onc.dat[!onc.dat[, "tree.id"] %in% onc.tan[ ,1], "tree.id"]

onc.nc[grep("N1.", onc.nc[ ,1]), 1]
...
```{r com_chplot_onc, height = 8, width = 8}
