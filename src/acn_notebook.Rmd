...
### 
```{r "Network ordination", cache = TRUE, eval = TRUE, results = "show", dev = "pdf", fig.height = 5, fig.width = 5, warning = FALSE}
...
```{r "Std Plots Richness and Abundance", cache = TRUE, eval = TRUE, results = "show", dev = "pdf"}
...
```{r "Network metrics by genotype", cache = TRUE, eval = TRUE, results = "show", dev = "pdf"}
